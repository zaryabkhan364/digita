          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                  Boost your Company by Digita Developers
                </Heading>
                <Text as="p">
                  Let us take care of your business from building your web application to getting more leeds.
                </Text>
              </Box>
              <Box as="ul" sx={styles.list}>
                ...
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  "In-house" Engineers in Your Backyard
                </Text>
              </Box>
